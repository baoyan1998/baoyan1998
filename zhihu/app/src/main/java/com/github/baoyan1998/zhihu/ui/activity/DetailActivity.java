...
public class DetailActivity extends AppCompatActivity{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.comments) {
            ...
            intent.setClass(getApplicationContext(),PlActivity.class);
...
//                Log.i("baoyansb",detailBean.getTitle());
//            Log.i("baoyansb",detailBean.getImage());
//            Log.i("baoyansb",detailBean.getBody());
